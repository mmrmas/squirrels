...
fusen::fill_description(
  ...
  fields = list(
    Title = "Squeezing squirrel data",
    Description = "A package with functions to report on the squirrel dataset in R",
    `Authors@R` = c(
      person("Sam", "Linsen", email = "sam.linsen@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-1391-5715"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Sam Linsen")
```
...
# Code of Conduct
usethis::use_code_of_conduct("sam.linsen@finddx.org")
# NEWS
usethis::use_news_md()
```
